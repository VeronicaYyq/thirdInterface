package com.example.wxpay.service.impl;


import com.example.wxpay.model.WXConfigUtil;
import com.example.wxpay.service.WxService;
...
public class WxServiceImpl implements WxService {
    ...
    public static final String NOTIFY_URL = "https://dev.2boss.cn/superior/v1/pay/wxPayCallBack";
    ...
    public Map doUnifiedOrder() throws Exception {
        try {
            ...
            String body = "订单支付";
            data.put("body", body);
            data.put("out_trade_no", "1111298373999");
